...
public class RdfStreamReaderDatasetTest {
  ...
  public void testReader() throws Exception {
    ...
    while (namedGraphs.hasNext()) {
      ...
      assertTrue("Not equal graph: " + namedGraph, dataset.getNamedModel(namedGraph)
          .isIsomorphicWith(readDatasaet.getNamedModel(namedGraph)));
    }
    assertTrue("default graph not the same",
        dataset.getDefaultModel().isIsomorphicWith(readDatasaet.getDefaultModel()));
