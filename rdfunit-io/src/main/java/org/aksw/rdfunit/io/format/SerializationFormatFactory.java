...
public final class SerializationFormatFactory {
  ...
  public static SerializationFormat createHTML() {
    ...
    return new SerializationFormat(
        "html", SerializationFormatIOType.output, SerializationFormatGraphType.singleGraph, "html",
        "text/html", currentSynonyms);
  ...
  public static SerializationFormat createJunitXml() {
    ...
    return new SerializationFormat(
        "junitxml", SerializationFormatIOType.output, SerializationFormatGraphType.singleGraph,
        "xml", "application/xml", currentSynonyms);
  ...
  public static SerializationFormat createTurtle() {
    ...
    return new SerializationFormat(
        "TURTLE", SerializationFormatIOType.inputAndOutput,
        SerializationFormatGraphType.singleGraph, "ttl", "text/turtle", currentSynonyms);
  ...
  public static SerializationFormat createN3() {
    ...
    return new SerializationFormat(
        "N3", SerializationFormatIOType.inputAndOutput, SerializationFormatGraphType.singleGraph,
        "n3", "rdf+n3", currentSynonyms);
  }
  ...
  public static SerializationFormat createNTriples() {
    ...
    HashSet<String> currentSynonyms = Sets
        .newHashSet(Arrays.asList("n-triple", "n-triples", "ntriple", "ntriples", "nt"));
    return new SerializationFormat(
        "N-TRIPLE", SerializationFormatIOType.inputAndOutput,
        SerializationFormatGraphType.singleGraph, "nt", "application/n-triples", currentSynonyms);
  ...
  public static SerializationFormat createJsonLD() {
    ...
    HashSet<String> currentSynonyms = Sets
        .newHashSet(Arrays.asList("JSON-LD", "JSONLD", "JSON/LD"));
    return new SerializationFormat(
        "JSON-LD", SerializationFormatIOType.inputAndOutput,
        SerializationFormatGraphType.singleGraph, "jsonld", "application/ld+json", currentSynonyms);
  }
  ...
  public static SerializationFormat createRDFJson() {
    ...
    HashSet<String> currentSynonyms = Sets
        .newHashSet(Arrays.asList("RDF/JSON", "RDF-JSON", "RDFJSON", "RJ"));
    return new SerializationFormat(
        "RDF/JSON", SerializationFormatIOType.inputAndOutput,
        SerializationFormatGraphType.singleGraph, "rj", "application/rdf+json", currentSynonyms);
  }
  ...
  public static SerializationFormat createRDFXMLAbbrevOut() {
    ...
    HashSet<String> currentSynonyms = Sets
        .newHashSet(Arrays.asList("RDF/XML-ABBREV", "RDF-XML-ABBREV", "RDFXMLABBREV"));
    return new SerializationFormat(
        "RDF/XML-ABBREV", SerializationFormatIOType.output,
        SerializationFormatGraphType.singleGraph, "rdf", "application/rdf+xml", currentSynonyms);
  }
  ...
  public static SerializationFormat createRDFXMLOut() {
    ...
    HashSet<String> currentSynonyms = Sets
        .newHashSet(Arrays.asList("RDF/XML", "RDF-XML", "RDFXML"));
    return new SerializationFormat(
        "RDF/XML", SerializationFormatIOType.output, SerializationFormatGraphType.singleGraph,
        "rdf", "application/rdf+xml", currentSynonyms);
  ...
  public static SerializationFormat createRDFXMLIn() {
    ...
    HashSet<String> currentSynonyms = Sets
        .newHashSet("RDF/XML", "RDF-XML", "RDFXML", "RDF/XML-ABBREV", "RDF-XML-ABBREV",
            "RDFXML-ABBREV", "RDFXMLABBREV", "RDF", "XML", "OWL");
    return new SerializationFormat(
        "RDF/XML", SerializationFormatIOType.input, SerializationFormatGraphType.singleGraph, "rdf",
        "application/rdf+xml", currentSynonyms);
  ...
  public static SerializationFormat createRDFa() {
    ...
    return new SerializationFormat(
        "RDFA", SerializationFormatIOType.input, SerializationFormatGraphType.singleGraph, "html",
        "text/html", currentSynonyms);
  ...
  public static SerializationFormat createNQads() {
    // RDF/XML -> input
    HashSet<String> currentSynonyms = Sets
        .newHashSet(Arrays.asList("nq", "nquads", "n-quads", "nquad", "n-quad"));
    return new SerializationFormat(
        "NQuads", SerializationFormatIOType.inputAndOutput, SerializationFormatGraphType.dataset,
        "nq", "text/n-quads", currentSynonyms);
  ...
  public static SerializationFormat createTriX() {
    ...
    return new SerializationFormat(
        "TriX", SerializationFormatIOType.inputAndOutput, SerializationFormatGraphType.dataset,
        "trix", "application/trix", currentSynonyms);
  ...
  public static SerializationFormat createTriG() {
    ...
    return new SerializationFormat(
        "TriG", SerializationFormatIOType.inputAndOutput, SerializationFormatGraphType.dataset,
        "trix", "application/x-trig", currentSynonyms);
