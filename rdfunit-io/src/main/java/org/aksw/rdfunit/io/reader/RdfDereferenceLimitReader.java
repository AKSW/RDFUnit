...
/**
 * Checks the size of the remote location and continues only if it is below a certain limit If the
 * size cannot be determined, {@code strict} determines what to do
 *
