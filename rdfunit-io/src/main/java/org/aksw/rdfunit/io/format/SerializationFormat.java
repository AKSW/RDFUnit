...
public class SerializationFormat {
  ...
  /**
   * A list of synonyms to make format parsing easier for NTRIPLES format it can be NTRIPLES,
   * NTRIPLE, NT, NT-RIPLES, NT-RIPLE, Case does not matter here!
   */
   ...
   */
  public SerializationFormat(String name, SerializationFormatIOType ioType,
      SerializationFormatGraphType graphType, String extension, String mimeType) {
  ...
  /**
   * Checks if this format is an output format (or input and output) and matches one of the
   * synonyms
   *
   * @param format the format e.g. "nt"
   * @return the boolean true if the format matches or false if it doesn't
  ...
  /**
   * Accorting to {@code SerializationFormatIOType} this can be an input / output or input and
  ...
  /**
   * Accorting to {@code SerializationFormatGraphType} this can be an single graph or dataset
   *
