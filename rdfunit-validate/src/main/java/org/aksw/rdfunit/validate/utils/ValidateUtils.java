...
public final class ValidateUtils {
  ...
  private static Options generateCLIOptions() {
    ...
    cliOptions.addOption("g", "graph", true,
        "the graphs to use (separate multiple graphs with ',' (no whitespaces) (defaults to '')");
    cliOptions.addOption("u", "uri", true,
        "the uri to use for dereferencing if not the same with `dataset`");
  ...
  private static void setCoverageCalculation(CommandLine commandLine,
  ...
  private static void setQueryTtlCachePaginationLimit(CommandLine commandLine,
      RDFUnitConfiguration configuration) throws ParameterException {
  ...
  private static void setTestAutogetCacheManual(CommandLine commandLine,
      RDFUnitConfiguration configuration) throws ParameterException {
  ...
  private static void setOutputFormats(CommandLine commandLine, RDFUnitConfiguration configuration)
      throws ParameterException {
  ...
  private static void setTestExecutionType(CommandLine commandLine,
      RDFUnitConfiguration configuration) {
  ...
  private static void setEnrichedSchemas(CommandLine commandLine,
      RDFUnitConfiguration configuration) {
    //Get enriched schema
  ...
  private static void setSchemas(CommandLine commandLine, RDFUnitConfiguration configuration)
      throws ParameterException {
  ...
  private static void setExcludeSchemata(CommandLine commandLine,
      RDFUnitConfiguration configuration) {
  ...
  private static void setDumpOrSparqlEndpoint(CommandLine commandLine,
      RDFUnitConfiguration configuration) {
  ...
  private static void checkIfRequiredParametersMissing(CommandLine commandLine)
      throws ParameterException {
