...
/**
 * RDFHTMLResultsWriter are different front he other RDFUnit writers because they write a
 * TestExecution initialized in construction and not the model provided in write(Model)
 *
...
public abstract class AbstractRdfHtmlResultsWriter implements RdfWriter {
  ...
  private StringBuilder getHeader() {
    ...
    header
        ...
        .append(
            "<link rel=\"stylesheet\" type=\"text/css\" href=\"https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.16.4/css/theme.default.css\" >\n")
        .append(
            "<script type=\"text/javascript\" src=\"https://code.jquery.com/jquery-1.11.0.min.js\"></script>\n")
        .append(
            "<script type=\"text/javascript\" src=\"https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.16.4/jquery.tablesorter.min.js\"></script>\n")
        .append(
  ...
  private StringBuilder getTestExecutionStats() {
    ...
    stats.append("<h2>TestExecution: ").append(testExecution.getTestExecutionUri())
        .append("</h2>\n");
    ...
    stats
        ...
        .append("<dt>Dataset</dt><dd> ").append(testExecution.getTestedDatasetUri())
        .append("</dd>\n")
        ...
        .append("<dt>Timeout / Error </dt><dd> T:").append(dor.getTimeoutTests()).append(" / E: ")
        .append(dor.getErrorTests()).append("</dd>\n")
        .append("<dt>Violation instances</dt><dd> ").append(dor.getIndividualErrors())
        .append("</dd>\n")
        .append("</dl>\n");
    return stats;
  }
  ...
  private StringBuilder getTestExecutionResults() {
    ...
    results
        ...
        .append(
            "<table id=\"myTable\" class=\"tablesorter tablesorter-default table\" summary=\"Detailed results\"><thead>\n")
