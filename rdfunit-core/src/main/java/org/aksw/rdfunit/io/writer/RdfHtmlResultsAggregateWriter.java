...
public class RdfHtmlResultsAggregateWriter extends RdfHtmlResultsStatusWriter {
  ...
  protected StringBuilder getResultsHeader() {
    return new StringBuilder(
        "<tr><th>Status</th><th>Level</th><th>Test Case</th><th>Errors</th><th>Prevalence</th></tr>\n");
  }
  ...
  private StringBuilder printResult(StringBuilder htmlString, String template,
    ...
    return htmlString.append(
        String.format(template,
            ...
            "<a href=\"" + result.getSeverity().getUri() + "\">" + result.getSeverity().name()
                + "</a>",
