...
public final class TestGeneratorFactory {
    ...
    public static RdfUnitTestGenerator create(Collection<TestGenerator> testGenerators, String testFolder, boolean useAutoTests, boolean loadFromCache, boolean useManualTests) {
        return create(testGenerators, testFolder, useAutoTests, loadFromCache, useManualTests, ImmutableList.of());
    }
    public static RdfUnitTestGenerator create(Collection<TestGenerator> testGenerators, String testFolder, boolean useAutoTests, boolean loadFromCache, boolean useManualTests, Collection<TestGeneratorExecutorMonitor> monitors) {
        // tag / cache
        ...
        if (useManualTests) {
            ...
            return new CompositeTestGenerator(ImmutableList.of(autoGeneratorsWithMonitor, manualGeneratorsWithMonitor));
