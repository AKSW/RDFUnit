...
public class DumpTestSource extends AbstractTestSource implements TestSource {
  ...
  DumpTestSource(SourceConfig sourceConfig, QueryingConfig queryingConfig,
      Collection<SchemaSource> referenceSchemata, RdfReader dumpReader, OntModel model) {
  ...
  DumpTestSource(SourceConfig sourceConfig, QueryingConfig queryingConfig,
    ...
    this(sourceConfig, queryingConfig, referenceSchemata, dumpReader, ModelFactory
        .createOntologyModel(OntModelSpec.OWL_DL_MEM,
            ModelFactory.createDefaultModel()));  //OntModelSpec.RDFS_MEM_RDFS_INF
  }

  DumpTestSource(DumpTestSource dumpTestSource, Collection<SchemaSource> referenceSchemata) {
    this(dumpTestSource.sourceConfig, dumpTestSource.queryingConfig, referenceSchemata,
        dumpTestSource.dumpReader, dumpTestSource.dumpModel);
  }
