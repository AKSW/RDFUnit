...
public final class SchemaSourceFactory {
  ...
  public static SchemaSource createSchemaSourceFromCache(String baseFolder, String prefix,
      String uri) {
    return createSchemaSourceFromCache(baseFolder, prefix, uri, uri);
  }

  public static SchemaSource createSchemaSourceFromCache(String baseFolder, String prefix,
      String uri, String schema) {
    String cacheFile = CacheUtils
        .getSchemaSourceCacheFilename(baseFolder, TestAppliesTo.Schema, prefix, uri);
  ...
  public static SchemaSource createSchemaSourceDereference(String prefix, String uri,
      String schema) {
    return createSchemaSourceSimple(prefix, uri, schema,
        RdfReaderFactory.createDereferenceReader(schema));
  }

  public static EnrichedSchemaSource createEnrichedSchemaSourceFromCache(String baseFolder,
      String prefix, String uri) {
    String cacheFile = CacheUtils
        .getSchemaSourceCacheFilename(baseFolder, TestAppliesTo.EnrichedSchema, prefix, uri);
  ...
  public static SchemaSource createSchemaSourceFromText(String namespace, String text,
      String format) {

    String uri = namespace + StringUtils.getHashFromString(text);
    String prefix = UriToPathUtils.getAutoPrefixForURI(uri);

    return createSchemaSourceSimple(prefix, uri,
        RdfReaderFactory.createReaderFromText(text, format));
  }


  public static SchemaSource createSchemaSourceSimple(String uri) {

    return createSchemaSourceSimple(uri,
        RdfReaderFactory.createResourceOrFileOrDereferenceReader(uri));
  }
  ...
  public static SchemaSource createSchemaSourceSimple(String prefix, String uri, String schema,
      RdfReader reader) {
