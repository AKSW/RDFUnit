...
public final class TestSourceFactory {
  ...
  public static TestSource createDumpTestSource(String prefix, String uri, RdfReader dumpReader,
  ...
  public static TestSource createDumpTestSource(String prefix, String uri, Model model,
      Collection<SchemaSource> referenceSchemata) {
