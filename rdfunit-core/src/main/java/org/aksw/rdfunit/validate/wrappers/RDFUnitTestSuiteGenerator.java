...
public final class RDFUnitTestSuiteGenerator {
  ...
  @Getter(lazy = true)
  @NonNull
  private final RDFUnit rdfUnit = initRdfUnit();
  ...
  @Getter(lazy = true)
  @NonNull
  private final TestSuite testSuite = initTestSuite();


  private RDFUnitTestSuiteGenerator(Collection<SchemaSource> schemas, boolean enableAutoTests,
      boolean enableManualTests) {
  ...
  private TestSuite initTestSuite() {
    ...
    TestSource dummyTestSource = TestSourceFactory
        .createDumpTestSource("dummy", "dummy", RdfReaderFactory.createEmptyReader(), schemas);
    ...
    return testGeneratorExecutor
        .generateTestSuite("", dummyTestSource, getRdfUnit().getAutoGenerators());
  }
  ...
  public static class Builder {
    ...
    public Builder addSchemaURI(String prefix, String schemaUri) {
      ...
      SchemaSource schemaSource = createSource(prefix, schemaUri,
    ...
    public Builder addLocalResource(String prefix, String localResource) {
      ...
      SchemaSource schemaSource = createSource(prefix, localResource,
    ...
    public Builder addLocalResourceOrSchemaURI(String prefix, String localResource,
        String schemaUri) {
      checkNotNull(localResource);
      checkNotNull(schemaUri);
