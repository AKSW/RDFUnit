...
public final class RDFUnitStaticValidator {
  ...
  public static TestExecution validate(final Model inputModel,
      final TestCaseExecutionType executionType) throws Exception {
  ...
  public static TestExecution validate(final Model inputModel,
      final TestCaseExecutionType executionType, final String inputURI) throws Exception {
  ...
  public static TestExecution validate(final Model inputModel,
      final TestCaseExecutionType executionType, final String inputURI,
      DatasetOverviewResults overviewResults) throws Exception {
  ...
  public static TestExecution validate(final TestCaseExecutionType testCaseExecutionType,
      final Model model, final TestSuite testSuite) {
  ...
  /**
   * Static method that validates a Source. In this case the Source and TestSuite are provided as
   * argument along with a RDFUnitConfiguration object This function can also serve as standalone
   */
  public static TestExecution validate(final TestCaseExecutionType testCaseExecutionType,
      final TestSource testSource, final TestSuite testSuite,
      DatasetOverviewResults overviewResults) {
    return validate(testCaseExecutionType, testSource, testSuite, "http://localhost",
        overviewResults);
  }
   ...
   */
  public static TestExecution validate(final TestCaseExecutionType testCaseExecutionType,
      final TestSource testSource, final TestSuite testSuite, final String agentID,
      DatasetOverviewResults overviewResults) {
