...
public class RdfResultsWriterFactoryTest {
  ...
  public static Collection<Object[]> resources() throws RdfReaderException {
    ...
    Model aggregated = new RdfModelReader(RdfReaderFactory.createResourceOrFileOrDereferenceReader(
        "../rdfunit-model/src/test/resources/org/aksw/rdfunit/model/results/sample.aggregatedTestCaseResult.ttl")
        .read()).read();
    Model status = new RdfModelReader(RdfReaderFactory.createResourceOrFileOrDereferenceReader(
        "../rdfunit-model/src/test/resources/org/aksw/rdfunit/model/results/sample.statusTestCaseResult.ttl")
        .read()).read();
    Model shacl = new RdfModelReader(RdfReaderFactory.createResourceOrFileOrDereferenceReader(
        "../rdfunit-model/src/test/resources/org/aksw/rdfunit/model/results/sample.shaclTestCaseResult.ttl")
        .read()).read();
    Model shacllite = new RdfModelReader(RdfReaderFactory.createResourceOrFileOrDereferenceReader(
        "../rdfunit-model/src/test/resources/org/aksw/rdfunit/model/results/sample.shaclLiteTestCaseResult.ttl")
        .read()).read();
  ...
  private String getHtmlForExecution(TestExecution testExecution)
      throws RdfWriterException, UnsupportedEncodingException {
    final ByteArrayOutputStream os = new ByteArrayOutputStream();
    RdfResultsWriterFactory.createHtmlWriter(testExecution, os)
        .write(ModelFactory.createDefaultModel());
    return os.toString("UTF8");
  }

  private String getXmlForExecution(TestExecution testExecution)
      throws RdfWriterException, UnsupportedEncodingException {
    final ByteArrayOutputStream os = new ByteArrayOutputStream();
    RdfResultsWriterFactory.createJunitXmlWriter(testExecution, os)
        .write(ModelFactory.createDefaultModel());
    return os.toString("UTF8");
  }
