...
public class AbstractTestSourceTest {
  ...
  public void setUp() {
    ...
    queryingConfig = QueryingConfig
        .create(TESTCacheTTL, TESTQueryDelay, TESTTestqueryLimit, TESTPagination);
    sourceConfig = new SourceConfig(TESTSourcePrefix, TESTSourceURI);

    abstractTestSource = new AbstractTestSource(sourceConfig, queryingConfig,
        TESTReferenceSchemata) {
      @Override
