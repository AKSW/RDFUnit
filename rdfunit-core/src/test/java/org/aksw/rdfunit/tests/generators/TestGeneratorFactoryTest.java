...
public class TestGeneratorFactoryTest {
  ...
  private static final TestSource testSource = TestSourceFactory
      .createDumpTestSource("dbpedia.org", "http://dbpedia.org", ModelFactory.createDefaultModel(),
          ImmutableList.of());
  private static final SchemaSource schemaSourceOwl = SchemaSourceFactory
      .createSchemaSourceSimple("exowl", "http://example.com/owl",
          RdfReaderFactory
              .createResourceReader("/org/aksw/rdfunit/tests/generators/generate.test.owl.ttl"));
  private static final SchemaSource schemaSourceShacl = SchemaSourceFactory
      .createSchemaSourceSimple("exshacl", "http://example.com/shacl",
          RdfReaderFactory
              .createResourceReader("/org/aksw/rdfunit/tests/generators/generate.test.shacl.ttl"));
  ...
  public void testAllNoCache() {
    RdfUnitTestGenerator g = TestGeneratorFactory
        .createAllNoCache(rdfUnit.getAutoGenerators(), testFolder);
