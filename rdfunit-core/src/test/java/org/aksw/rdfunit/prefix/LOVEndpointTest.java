...
public class LOVEndpointTest {
    ...
    public void testExtractResourceLocation() {
        ...
        SchemaEntry entry5 = new SchemaEntry("agr", "https://promsns.org/def/agr", "http://promsns.org/def/agr#");
        ...
        SchemaEntry entry9 = new SchemaEntry("medred", "http://w3id.org/medred/medred", "http://w3id.org/medred/medred#");
        SchemaEntry result9 = endpoint.extractResourceLocation(entry9);
        Assert.assertEquals( "https://jpcik.github.io/medred/onto/medred/ontology.n3", result9.getVocabularyDefinedBy());

        SchemaEntry entry8 = new SchemaEntry("comm", "http://vocab.resc.info/communication", "http://vocab.resc.info/communication#");
        SchemaEntry result8 = endpoint.extractResourceLocation(entry8);
        Assert.assertEquals( "http://vocab.resc.info/communication.rdf", result8.getVocabularyDefinedBy());
        ...
        Assert.assertEquals( "https://brk.basisregistraties.overheid.nl/def/brk.owl", result4.getVocabularyDefinedBy());
