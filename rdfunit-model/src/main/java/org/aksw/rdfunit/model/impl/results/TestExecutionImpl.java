...
public class TestExecutionImpl implements TestExecution {
  ...
  private TestExecutionImpl(Builder builder) {
    ...
    this.testedDatasetUri = checkNotNull(builder.testedDatasetUri,
        "Tested dataset URI is needed in TestExecution");
    ...
    this.testCaseExecutionType = checkNotNull(builder.testCaseExecutionType,
        "Test execution type is needed in TestExecution");
    this.startedByAgent = checkNotNull(builder.startedByAgent,
        "Agent starting the execution is needed in TestExecution");

    this.schemata = ImmutableList
        .copyOf(checkNotNull(builder.schemata, "Used schemata are needed in TestExecution"));
    this.results = ImmutableList
        .copyOf(checkNotNull(builder.results, "Results are needed in TestExecution"));
    ...
    this.datasetOverviewResults = checkNotNull(builder.datasetOverviewResults,
        "Overview results are needed in TestExecution");
  ...
  public static class Builder {
    ...
    private List<TestCaseResult> results = new LinkedList<>();
