...
public class PatternBasedTestCaseImpl implements TestCase, PatternBasedTestCase {
  ...
  public PatternBasedTestCaseImpl(@NonNull Resource resource,
      @NonNull TestCaseAnnotation annotation, @NonNull Pattern pattern,
      @NonNull Collection<Binding> bindings) {
