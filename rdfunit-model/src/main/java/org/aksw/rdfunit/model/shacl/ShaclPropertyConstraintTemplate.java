...
public class ShaclPropertyConstraintTemplate {
    ...
    @NonNull @Getter @Singular private final ImmutableSet<ComponentParameter> componentParameters;
    @NonNull @Getter @Singular private final ImmutableMap<ComponentParameter, String> argumentFilters;
    ...
    private boolean canBind(PropertyValuePairSet propertyValuePairSet, ComponentParameter arg, String sparqlFilter) {
