...
public final class ResultAnnotationWriter implements ElementWriter {
  ...
  private ResultAnnotationWriter(ResultAnnotation resultAnnotation, Resource annotationClazz,
      Property propertyP, Property valueP, Property varNameP) {
  ...
  public static ResultAnnotationWriter create(ResultAnnotation resultAnnotation) {
    return createResultAnnotationWriterRut(resultAnnotation);
  }

  public static ResultAnnotationWriter createResultAnnotationWriterRut(
      ResultAnnotation resultAnnotation) {
    return new ResultAnnotationWriter(resultAnnotation, RDFUNITv.ResultAnnotation,
        RDFUNITv.annotationProperty, RDFUNITv.annotationValue, RDFUNITv.annotationValue);
  }

  public static ResultAnnotationWriter createResultAnnotationWriterShacl(
      ResultAnnotation resultAnnotation) {
    return new ResultAnnotationWriter(resultAnnotation, SHACL.ResultAnnotation,
        SHACL.annotationProperty, SHACL.annotationValue, SHACL.annotationVarName);
  }
