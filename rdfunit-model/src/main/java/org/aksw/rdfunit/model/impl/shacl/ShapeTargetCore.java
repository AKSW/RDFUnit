...
public class ShapeTargetCore implements ShapeTarget {
  ...
  @Getter
  private final ShapeTargetType targetType;
  @Getter
  private final RDFNode node;
  private final Function<RDFNode, String> generatePattern;

  private ShapeTargetCore(ShapeTargetType targetType, RDFNode node,
      Function<RDFNode, String> generatePattern) {
  ...
  private static String classTargetPattern(RDFNode node) {
    return getBindedSparql(
        " ?this <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>/<http://www.w3.org/2000/01/rdf-schema#subClassOf>* ?target . ",
        node);
  }
