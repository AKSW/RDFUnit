...
/**
 * Takes a sparqlPattern and a SPARQL query and based on the data returned from that query we
 * generate test cases
 *
...
public final class TestGeneratorImpl implements TestGenerator {
  ...
  @Builder
  private TestGeneratorImpl(Resource element, String description, String query, Pattern pattern,
  ...
  public static TestGenerator createTAG(Resource element, String description, String query,
      Pattern pattern, Collection<ResultAnnotation> generatorAnnotations) {
