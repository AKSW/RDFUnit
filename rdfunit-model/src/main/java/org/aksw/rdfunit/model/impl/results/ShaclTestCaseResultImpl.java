...
public class ShaclTestCaseResultImpl extends ShaclLiteTestCaseResultImpl implements
    ShaclTestCaseResult {

  private final ImmutableSet<PropertyValuePair> resultAnnotations;


  public ShaclTestCaseResultImpl(Resource testCaseUri, RLOGLevel severity, String message,
      RDFNode focusNode, Set<PropertyValuePair> resultAnnotations) {
    super(testCaseUri, severity, message, focusNode);
    this.resultAnnotations = ImmutableSet.copyOf(checkNotNull(resultAnnotations));
  }

  public ShaclTestCaseResultImpl(Resource element, Resource testCaseUri, RLOGLevel severity,
  ...
  public static class Builder {
    ...
    public Builder(Resource testCaseUri, RLOGLevel severity, String message, RDFNode focusNode) {
      shaclLiteTestCaseResult = new ShaclLiteTestCaseResultImpl(testCaseUri, severity, message,
          focusNode);
    }
