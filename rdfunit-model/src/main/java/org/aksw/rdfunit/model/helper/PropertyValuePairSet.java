...
/**
 * holds a simple set of property value pairs but on build groups the values with the same
 * properties
 *
...
public class PropertyValuePairSet {
  ...
  private Collection<RDFNode> getPropertyValues(Property property,
      Set<PropertyValuePair> annotationSet) {
  ...
  private Set<PropertyValuePair> groupAnnotationsPerProperty(
      Set<PropertyValuePair> ungroupedAnnotations) {
