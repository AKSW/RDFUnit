...
public class PrefixDeclarationReader implements ElementReader<PrefixDeclaration> {
    ...
    public static PrefixDeclarationReader create() { return new PrefixDeclarationReader();}

    @Override
    public PrefixDeclaration read(Resource resource) {
        checkNotNull(resource);

        PrefixDeclarationImpl.PrefixDeclarationImplBuilder prefixDeclarationImplBuilder = PrefixDeclarationImpl.builder();
