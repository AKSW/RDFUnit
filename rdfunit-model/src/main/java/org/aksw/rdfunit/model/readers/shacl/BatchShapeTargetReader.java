...
public final class BatchShapeTargetReader {
  ...
  private List<ShapeTarget> collectSubjectsOfTarget(Resource resource) {
    return collectPropertyHelper(resource, SHACL.targetSubjectsOf,
        ShapeTargetType.SubjectsOfTarget);
  }
  ...
  private List<ShapeTarget> collectPropertyHelper(Resource resourceShape, Property targetProperty,
      ShapeTargetType shapeTargetType) {
