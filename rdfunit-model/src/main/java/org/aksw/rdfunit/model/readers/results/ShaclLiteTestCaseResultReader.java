...
public final class ShaclLiteTestCaseResultReader implements ElementReader<ShaclLiteTestCaseResult> {
  ...
  public static ShaclLiteTestCaseResultReader create() {
    return new ShaclLiteTestCaseResultReader();
  }
  ...
  public ShaclLiteTestCaseResult read(final Resource resource) {
    ...
    return new ShaclLiteTestCaseResultImpl(resource, test.getTestCaseUri(), test.getSeverity(),
        test.getMessage(), test.getTimestamp(), focusNode);
  }
}
