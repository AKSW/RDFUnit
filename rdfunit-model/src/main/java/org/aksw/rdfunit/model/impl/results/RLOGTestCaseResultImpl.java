 ...
 * @version $Id: $Id
 */
public class RLOGTestCaseResultImpl extends TestCaseResultImpl implements RLOGTestCaseResult {
     ...
     */
    public RLOGTestCaseResultImpl(TestCase testCase, String resource, String message, RLOGLevel logLevel) {
        super(testCase);
