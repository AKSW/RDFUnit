...
public final class SHACL {
  ...
  public static final Property atomic = ResourceFactory.createProperty(
      "http://example.org/atomic/wrapper");      //TODO need a property expressing a singleton, non negating group
  public static final Property violating = ResourceFactory
      .createProperty("http://example.org/atomic/wrapper");
