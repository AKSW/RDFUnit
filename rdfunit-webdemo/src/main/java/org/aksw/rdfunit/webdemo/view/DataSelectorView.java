...
final class DataSelectorView extends CustomComponent implements WorkflowItem {
  ...
  public boolean execute() {
    ...
    RDFUnitConfiguration configuration = new RDFUnitConfiguration(uri,
        RDFUnitDemoSession.getBaseDir());
    ...
    try {
      ...
      QueryExecutionFactoryModel qefm = (QueryExecutionFactoryModel) configuration.getTestSource()
          .getExecutionFactory();
      ...
      DataSelectorView.this
          .setMessage("Data loaded successfully! (" + qefm.getModel().size() + " statements)",
              false);
