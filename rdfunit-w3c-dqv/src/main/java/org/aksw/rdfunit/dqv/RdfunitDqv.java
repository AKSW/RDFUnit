...
public final class RdfunitDqv {
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (Resource testExecutionResource : input.read()
      ...
      Collection<QualityMeasure> report = new DqvReport(testExecution, MetricMapper.createDefault())
          .getQualityMeasures();
  ...
  private static RdfReader getInputReader(CommandLine commandLine) {
    ...
    return RdfReaderFactory
        .createResourceOrFileOrDereferenceReader(commandLine.getOptionValue("i"));
  }
